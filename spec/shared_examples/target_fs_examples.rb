...
#   let(:filepath){ File.join(dir.path, 'test.txt') }

#   describe '#ls' do
#     it 'lists files' do
#       files = %w(a b)
#       files.each do |letter|
#         subject.append(File.join(dir.path, letter), letter)
#       end
#       expect(subject.ls(dir.path)).to eq files
#     end
#   end
...
#       }.to raise_error(NeutronicHelper::FileNotFoundError, /not found/)
#     end
#   end
